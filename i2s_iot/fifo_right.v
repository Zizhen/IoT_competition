...
/* Module Version: 5.8 */
/* C:\lscc\diamond\3.9_x64\ispfpga\bin\nt64\scuba.exe -w -n fifo_right -lang verilog -synth lse -bus_exp 7 -bb -arch xo3c00a -type ebfifo -depth 16 -width 16 -rwidth 16 -no_enable -pe 4 -pf 16  */
/* Mon Apr 10 00:44:23 2017 */
...
module fifo_right (Data, WrClock, RdClock, WrEn, RdEn, Reset, RPReset, Q, 
    ...
    defparam fifo_right_0_0.FULLPOINTER1 = "0b00000011110000" ;
    defparam fifo_right_0_0.FULLPOINTER = "0b00000100000000" ;
    defparam fifo_right_0_0.AFPOINTER1 = "0b00000011110000" ;
    defparam fifo_right_0_0.AFPOINTER = "0b00000100000000" ;
    defparam fifo_right_0_0.AEPOINTER1 = "0b00000001010000" ;
    defparam fifo_right_0_0.AEPOINTER = "0b00000001000000" ;
    ...
    FIFO8KB fifo_right_0_0 (.DI0(Data[0]), .DI1(Data[1]), .DI2(Data[2]), 
