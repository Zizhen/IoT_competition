...
/* Module Version: 5.7 */
/* C:\lscc\diamond\3.9_x64\ispfpga\bin\nt64\scuba.exe -w -n pll2 -lang verilog -synth lse -arch xo3c00a -type pll -fin 16.63 -fclkop 33.26 -fclkop_tol 0.0 -fclkos 5.543333 -fclkos_tol 0.2 -trimp 0 -phasep 0 -trimp_r -trims 0 -phases 0 -trims_r -phase_cntl STATIC -rst -fb_mode 1 -lock  */
/* Sun Apr 09 21:04:41 2017 */


`timescale 1 ns / 1 ps
module pll2 (CLKI, RST, CLKOP, CLKOS, LOCK)/* synthesis NGD_DRC_MASK=1 */;
    input wire CLKI;
    input wire RST;
    output wire CLKOP;
    output wire CLKOS;
