...
/* Module Version: 5.8 */
/* C:\lscc\diamond\3.9_x64\ispfpga\bin\nt64\scuba.exe -w -n fifo_left -lang verilog -synth lse -bus_exp 7 -bb -arch xo3c00a -type ebfifo -depth 16 -width 16 -rwidth 16 -no_enable -pe 4 -pf 14  */
...
module fifo_left (Data, WrClock, RdClock, WrEn, RdEn, Reset, RPReset, Q, 
    ...
    defparam fifo_left_0_0.FULLPOINTER1 = "0b00000011110000" ;
    defparam fifo_left_0_0.FULLPOINTER = "0b00000100000000" ;
