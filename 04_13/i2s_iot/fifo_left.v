...
/* Module Version: 5.8 */
/* C:\lscc\diamond\3.9_x64\ispfpga\bin\nt64\scuba.exe -w -n fifo_left -lang verilog -synth lse -bus_exp 7 -bb -arch xo3c00a -type ebfifo -depth 256 -width 16 -rwidth 16 -no_enable -pe 4 -pf 14  */
/* Tue Apr 11 14:51:57 2017 */


`timescale 1 ns / 1 ps
module fifo_left (Data, WrClock, RdClock, WrEn, RdEn, Reset, RPReset, Q, 
    ...
    defparam fifo_left_0_0.FULLPOINTER1 = "0b00111111110000" ;
    defparam fifo_left_0_0.FULLPOINTER = "0b01000000000000" ;
    defparam fifo_left_0_0.AFPOINTER1 = "0b00000011010000" ;
    defparam fifo_left_0_0.AFPOINTER = "0b00000011100000" ;
    defparam fifo_left_0_0.AEPOINTER1 = "0b00000001010000" ;
    defparam fifo_left_0_0.AEPOINTER = "0b00000001000000" ;
    ...
    FIFO8KB fifo_left_0_0 (.DI0(Data[0]), .DI1(Data[1]), .DI2(Data[2]), 
