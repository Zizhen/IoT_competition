...
`timescale 1 ns / 1 ps
module pll1 (CLKI, RST, CLKOP, CLKOS, CLKOS2, LOCK)/* synthesis syn_noprune=1 *//* synthesis NGD_DRC_MASK=1 */;// exemplar attribute pll1 dont_touch true 
    input wire CLKI;
    input wire RST;
    output wire CLKOP;
    output wire CLKOS;
    ...
    EHXPLLJ PLLInst_0 (.CLKI(CLKI), .CLKFB(CLKOP_t), .PHASESEL1(scuba_vlo), 
        ...
        .PLLDATO2(), .PLLDATO1(), .PLLDATO0())
             ...
             /* synthesis FREQUENCY_PIN_CLKOS="0.500000" */
    ...
    // exemplar attribute PLLInst_0 FREQUENCY_PIN_CLKOS 0.500000
