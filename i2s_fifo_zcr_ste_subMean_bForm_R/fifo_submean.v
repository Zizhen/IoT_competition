...
/* Module Version: 5.7 */
/* C:\lscc\diamond\3.4\ispfpga\bin\nt\scuba.exe -w -n fifo_submean -lang verilog -synth synplify -bus_exp 7 -bb -arch xo3c00a -type ebfifo -depth 16 -width 15 -rwidth 15 -regout -resetmode ASYNC -reset_rel SYNC -pe 10 -pf 10  */
/* Thu Mar 09 12:55:36 2017 */


`timescale 1 ns / 1 ps
module fifo_submean (Data, WrClock, RdClock, WrEn, RdEn, Reset, RPReset, 
    ...
    FIFO8KB fifo_submean_0_0 (.DI0(Data[0]), .DI1(Data[1]), .DI2(Data[2]), 
        .DI3(Data[3]), .DI4(Data[4]), .DI5(Data[5]), .DI6(Data[6]), .DI7(Data[7]), 
        .DI8(Data[8]), .DI9(Data[9]), .DI10(Data[10]), .DI11(Data[11]), 
        .DI12(Data[12]), .DI13(Data[13]), .DI14(Data[14]), .DI15(scuba_vlo), 
        ...
        .DO3(Q[12]), .DO4(Q[13]), .DO5(Q[14]), .DO6(), .DO7(), .DO8(), .DO9(Q[0]), 
        .DO10(Q[1]), .DO11(Q[2]), .DO12(Q[3]), .DO13(Q[4]), .DO14(Q[5]), 
        .DO15(Q[6]), .DO16(Q[7]), .DO17(Q[8]), .EF(Empty_int), .AEF(AlmostEmpty), 
