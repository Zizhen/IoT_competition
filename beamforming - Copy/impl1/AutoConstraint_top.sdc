...
define_clock -name {pll1|CLKOP_inferred_clock} {n:pll1|CLKOP_inferred_clock} -period 6.116 -clockgroup Autoconstr_clkgroup_0 -rise 0.000 -fall 3.058 -route 0.000 
