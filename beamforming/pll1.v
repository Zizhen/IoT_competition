...
/* Module Version: 5.7 */
/* C:\lscc\diamond\3.4\ispfpga\bin\nt\scuba.exe -w -n pll1 -lang verilog -synth synplify -arch xo3c00a -type pll -fin 16 -fclkop 32 -fclkop_tol 1.0 -fclkos 4 -fclkos_tol 0.0 -trimp 0 -phasep 0 -trimp_r -trims 0 -phases 0 -trims_r -phase_cntl STATIC -rst -fb_mode 1 -lock  */
/* Tue Mar 07 17:27:20 2017 */


`timescale 1 ns / 1 ps
module pll1 (CLKI, RST, CLKOP, CLKOS, LOCK)/* synthesis syn_noprune=1 *//* synthesis NGD_DRC_MASK=1 */;// exemplar attribute pll1 dont_touch true 
    input wire CLKI;
    input wire RST;
    output wire CLKOP;
    output wire CLKOS;
